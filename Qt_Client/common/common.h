...
// 文件路径
const QString CONFFILE      = "D:/MyProject/C++/FileServer/project/Code/Qt_Client/Client/conf/cfg.json";     // 配置文件
const QString  RECORDDIR    = "D:/MyProject/C++/FileServer/project/Code/Qt_Client/Client/conf/record/";      // 用户文件上传下载记录
const QString  FILETYPEDIR  = "D:/MyProject/C++/FileServer/project/Code/Qt_Client/Client/conf/fileType";     // 存放文件类型图片目录
